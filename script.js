...
function newCard(){nameInput.value='';messageInput.value='';charCount.textContent='٠';currentDesign=0;const first=document.querySelector('input[name="design"]');if(first)first.checked=true;previewSection.hidden=true;currentImage=null;canvas.width=0;canvas.height=0;window.scrollTo({top:0,behavior:'smooth'});nameInput.focus()}
